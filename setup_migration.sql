...
VALUES
  ('Operador Padrao','Acesso basico: apenas abrir caixa e registrar vendas.','operador','{"can_void_sale":false,"can_edit_stock":false,"can_open_cash":true,"can_do_sangria":false,"can_view_reports":false,"can_close_cash":false,"can_manage_products":false}'::jsonb,true,NULL),
  ('Gerente','Gerencia caixa, estoque, sangria, relatorios e fechamento.','gerente','{"can_void_sale":false,"can_edit_stock":true,"can_open_cash":true,"can_do_sangria":true,"can_view_reports":true,"can_close_cash":true,"can_manage_products":false}'::jsonb,false,NULL),
  ('Admin Completo','Acesso total ao sistema.','admin','{"can_void_sale":true,"can_edit_stock":true,"can_open_cash":true,"can_do_sangria":true,"can_view_reports":true,"can_close_cash":true,"can_manage_products":true}'::jsonb,false,NULL),
  ('Caixa Simples','Apenas abertura do caixa e registro de vendas.','operador','{"can_void_sale":false,"can_edit_stock":false,"can_open_cash":true,"can_do_sangria":false,"can_view_reports":false,"can_close_cash":false,"can_manage_products":false}'::jsonb,false,NULL)
...
-- ── 5. RPC get_my_registers() — SOLUÇÃO DEFINITIVA ──────────
-- Função SECURITY DEFINER: roda como postgres, ignora RLS,
-- ignora o schema cache do PostgREST. Nunca retorna 400.
-- Também cria "Caixa Principal" automaticamente se a org
-- não tiver nenhum caixa cadastrado.
...
BEGIN
  ...
  -- Auto-criar "Caixa Principal" se a org não tiver nenhum caixa
  IF NOT EXISTS (
