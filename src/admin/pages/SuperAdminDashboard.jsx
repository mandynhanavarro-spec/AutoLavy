                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <button onClick={() => planosTabRef.current?.openNewPlan()} className="w-full flex items-center gap-3 rounded-xl bg-violet-50 px-4 py-3 text-violet-700 font-bold text-sm hover:bg-violet-100 transition-colors">
